...
#define FRSIZE 512 
#define FFTSIZE 1024  // FFT size = 2*FRSIZE
#define FRSTEP 256  // 50% overlap
#define NUM_NOISEFR 5  // Initial noise estimation
#define NUM_ITBAND 18  // number of band for intelligibility (명료성)
#define EPS 2.22e-16
#define PI 3.14159265358979323846
#define BUFFSIZE 512 // 32ms for 16kHz sampling rate
